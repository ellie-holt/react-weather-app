...
export default function WeatherMain({ weatherData, unit }) {
  ...
  return (
    <section
      className={`${themeClass} weatherMain flex flex-col xss:mt-5 sm:mt-6 lg:mt-10 mx-4 xss:mx-12 sm:mx-16 md:mx-28 mlg:mx-10 mlg: px-4 font-ubuntu`}
    >
      ...
      <h2 className="description mlg:order-last italic text-[2.5rem] 2xs:text-5xl lg:text-[3.5rem] tracking-tight leading-none w-3/5 mlg:w-full lg:mt-[-1rem] lg:mb-1 min-h-28 ">
        {weatherData.description.charAt(0).toUpperCase() +
          weatherData.description.slice(1)}
      </h2>
      <div className="self-end mt-[-6rem] 2xs:mt-[-4rem] sm:mt-[-6rem] mlg:mt-[-4rem] sm:mb-4 pb-5 px-3">
        <img
          src={icon}
